...
var x = localStorage.getItem('x'); // x是字符串 需要转成对象

var xObject = JSON.parse(x); //需要注意第一次的时候xObject是空的 若为空则使用默认值 否则获取localStorage里面的值
...
//# sourceMappingURL=main.4676c6a8.js.map